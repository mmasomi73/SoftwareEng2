...
<div class="login-container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            {!! Form::open(array('url' => '/logincheck', 'method' => "post", 'role'=> "form", 'id' =>"login" , 'class'=>"login-form fade-in-effect")) !!}
            <div class="login-header">
                <a href="#" class="logo">
                    <img src="{!!url('assets')!!}/images/icon.png" alt="" width="80" />
                    <span>log in</span>
                </a>

                <p>Dear user, log in to access the Panel !</p>
            </div>
